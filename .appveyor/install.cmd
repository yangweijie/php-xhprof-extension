...
setlocal enableextensions enabledelayedexpansion
	...
	if "%PHP_REL%"=="master" (
		echo git clone -q --depth=1 --branch=%PHP_REL% https://raw.kkgithub.com/php/php-src C:\projects\php-src
		git clone -q --depth=1 --branch=%PHP_REL% https://raw.kkgithub.com/php/php-src C:\projects\php-src
	) else (
		echo git clone -q --depth=1 --branch=PHP-%PHP_REL% https://raw.kkgithub.com/php/php-src C:\projects\php-src
		git clone -q --depth=1 --branch=PHP-%PHP_REL% https://raw.kkgithub.com/php/php-src C:\projects\php-src
	)
